...
<div class="wrapper wrapper-content  animated fadeInRight blog">
    <div class="row">
        <div class="col-lg-12">
            <c:forEach items="${requestScope.pagers.rows}" var="article">
                <div class="ibox">
                    <div class="ibox-content">
                        ...
                        <a href="<%=path %>/article/queryById/${article.id}/${requestScope.articleType}">
                            <p>
                                ${article.abstracts}
                            </p>
                        </a>
                        <p style="text-align: right">
                            <a href="<%=path %>/article/queryById/${article.id}/${requestScope.articleType}" class="btn-link title">更多></a>
                        </p>
            ...
            <div class="btn-group pull-right" style="margin-top: 30px;">
                <button class="btn btn-white btn-sm" onclick="previous('${requestScope.pager.pageNo}', '${requestScope.articleType}')"><img src="<%=path %>/images/left.png" alt="上一页" /></i>
                </button>
...
<script>
    function previous(pageNo, type) {
        var pageNo1 = parseInt(pageNo) - 1;
        window.location.href = "<%=path %>/article/search_pager_type?type=" + type + "&page=" + pageNo1 + "&rows=10";
    }
