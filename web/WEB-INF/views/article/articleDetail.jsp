            ...
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <p style="text-align: right" id="date">
                        <fmt:formatDate value="${requestScope.article.pubTime}" pattern="yyyy-MM-dd HH:DD:ss"></fmt:formatDate>
                    </p>
                    <div class="mail-body text-right tooltip-demo">
                        <a class="btn btn-sm btn-white" href="<%=path %>/article/search_pager_type?type=${requestScope.articleType}"><img
