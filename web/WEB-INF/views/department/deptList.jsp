...
<div class="wrapper wrapper-content  animated fadeInRight blog">
    <div class="row">
        <div class="col-lg-12">
            <c:forEach items="${requestScope.pagers.rows}" var="dept">
                <div class="ibox">
                    <div class="ibox-content">
                        <a href="<%=path %>/dept/queryById/${dept.id}" class="btn-link title" style="font-size: 26px; font-weight: bold; text-align: center;">
                            ${dept.name}
                        </a>
                        <p style="text-align: right">
                            <a href="<%=path %>/dept/queryById/${dept.id}" class="btn-link title">查看详情></a>
                        </p>
...
<script>
    function previous(pageNo) {
        ...
        window.location.href = "<%=path %>/dept/search_pager_type?page=" + pageNo1 + "&rows=10";
    }
